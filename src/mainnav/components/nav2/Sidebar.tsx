...
const LinarcLogo = ({ onHomeClick }: { onHomeClick?: () => void }) => (
    <svg
...
const Sidebar: React.FC<SidebarProps> = ({ version = 'v1', bookmarks = [], onSelect, onToggleBookmark, activeCategory, onHomeClick }) => {
    ...
    return (
        <aside className="w-[82px] bg-gray-50 border-r border-gray-200 flex flex-col shrink-0">
            <div className="flex-grow flex flex-col gap-2 pt-0">
                ...
                {/* Quick Create Button - Only for v2 */}
                {version === 'v2' && (
                    <QuickCreateMenu mode="sidebar" />
                )}
                ...
                {version === 'v2' && (
                    ...
                    >
                        <button
                            ...
                            className={`relative flex flex-col items-center justify-center gap-1.5 h-[80px] w-full text-xs font-medium transition-colors duration-200 ${isBookmarksMenuVisible
                                ? 'text-gray-900'
            ...
            <div className="py-4 w-[82px] flex justify-center">
                {version === 'v3' ? (
                    ...
                    <LinarcLogo onHomeClick={onHomeClick} />
                )}
            </div>
        </aside>
    );
