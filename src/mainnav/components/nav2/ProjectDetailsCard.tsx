        ...
        <Tooltip content={siteInfoText} position="bottom" delay={400} disabled={isExpanded}>
            ...
            >
                ...
                <button
                    ...
                    className="flex items-center gap-1.5 px-2 py-1 text-gray-400 hover:text-gray-300 hover:bg-gray-700/50 rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-cyan-500 touch-manipulation"
