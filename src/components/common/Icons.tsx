...
export const HandshakeIcon: React.FC<IconProps> = ({ title, ...props }) => (
...
export const MaximizeIcon: React.FC<IconProps> = ({ title, ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        {title && <title>{title}</title>}
...
export const FillColorIcon: React.FC<IconProps> = ({ title, ...props }) => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        {title && <title>{title}</title>}
        <path fillRule="evenodd" clipRule="evenodd" d="M7 2H17C18.6569 2 20 3.34315 20 5C21.6569 5 23 6.34315 23 8C23 11.2384 20.4344 13.8776 17.2249 13.9959L17 14H13C14.1046 14 15 14.8954 15 16V20C15 21.1046 14.1046 22 13 22H11C9.89543 22 9 21.1046 9 20V16C9 14.8954 9.89543 14 11 14V13C11 12.4872 11.386 12.0645 11.8834 12.0067L12 12H17C19.2091 12 21 10.2091 21 8C21 7.48716 20.614 7.06449 20.1166 7.00673L20 7C20 8.65685 18.6569 10 17 10H7C5.34315 10 4 8.65685 4 7V5C4 3.34315 5.34315 2 7 2ZM12 16H11V20H13V16H12ZM18 5V6V7C18 7.55228 17.5523 8 17 8H7C6.44772 8 6 7.55228 6 7V5C6 4.44772 6.44772 4 7 4H17C17.5523 4 18 4.44772 18 5Z" fill="currentColor"/>
    </svg>
);
...
export const BorderColorIcon: React.FC<IconProps> = ({ title, ...props }) => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      {title && <title>{title}</title>}
      <path fillRule="evenodd" clipRule="evenodd" d="M12 3H18C19.6569 3 21 4.34315 21 6V12V18C21 19.6569 19.6569 21 18 21H12H6C4.34315 21 3 19.6569 3 18V12V6C3 4.34315 4.34315 3 6 3H12ZM11 5H6C5.44772 5 5 5.44772 5 6V11H11V5ZM13 11V5H18C18.5523 5 19 5.44772 19 6V11H13ZM11 13H5V18C5 18.5523 5.44772 19 6 19H11V13ZM13 19V13H19V18C19 18.5523 18.5523 19 18 19H13Z" fill="currentColor"/>
    </svg>
);
...
export const UnlinkIcon: React.FC<IconProps> = ({ title, ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        {title && <title>{title}</title>}
        <path d="M18.84 8.35L21 6.2a5 5 0 0 0-7.07-7.07l-2.15 2.15" />
        <path d="M5.16 15.65L3 17.8a5 5 0 0 0 7.07 7.07l2.15-2.15" />
...
export const OctagonXIcon: React.FC<IconProps> = ({ title, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    {title && <title>{title}</title>}
    <path d="m15 9-6 6"/>
...
export const PanelLeftIcon: React.FC<IconProps> = ({ title, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    {title && <title>{title}</title>}
...
export const PanelRightIcon: React.FC<IconProps> = ({ title, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    {title && <title>{title}</title>}
    <rect width="18" height="18" x="3" y="3" rx="2"/>
    <path d="M15 3v18"/>
